...
!(function () {
  ...
  function n(e, t) {
    ...
    var i = this.__eventListeners[e];
    if (!i) return this;
    for (var n = 0, s = i.length; s > n; n++) i[n] && i[n].call(this, t || {});
    return (
      (this.__eventListeners[e] = i.filter(function (e) {
        return e !== !1;
      })),
      this
    );
...
fabric.Collection = {
  ...
  remove: function () {
    for (
      var e, t = this._objects, n = !1, i = 0, s = arguments.length;
      s > i;
      i++
    )
      (e = t.indexOf(arguments[i])),
        -1 !== e &&
          ((n = !0),
          t.splice(e, 1),
  ...
  forEachObject: function (e, t) {
    for (var n = this.getObjects(), i = 0, s = n.length; s > i; i++)
      e.call(t, n[i], i, n);
    return this;
  },
...
fabric.CommonMethods = {
  ...
  _initPattern: function (t, e, n) {
    !t || !t.source || t instanceof fabric.Pattern
      ? n && n()
      : this.set(e, new fabric.Pattern(t, n));
  },
...
!(function (t) {
  ...
  fabric.util = {
    ...
    rotatePoint: function (t, e, n) {
      t.subtractEquals(e);
      var r = fabric.util.rotateVector(t, n);
      return new fabric.Point(r.x, r.y).addEquals(e);
    },
    rotateVector: function (t, e) {
      var n = fabric.util.sin(e),
        r = fabric.util.cos(e),
        i = t.x * r - t.y * n,
        a = t.x * n + t.y * r;
      return { x: i, y: a };
    ...
    makeBoundingBoxFromPoints: function (t, e) {
      if (e)
        for (var n = 0; n < t.length; n++)
          t[n] = fabric.util.transformPoint(t[n], e);
      var r = [t[0].x, t[1].x, t[2].x, t[3].x],
        ...
        u = fabric.util.array.max(c),
        f = u - s;
      return { left: i, top: s, width: o, height: f };
    },
    invertTransform: function (t) {
      var e = 1 / (t[0] * t[3] - t[1] * t[2]),
        n = [e * t[3], -e * t[1], -e * t[2], e * t[0]],
        r = fabric.util.transformPoint({ x: t[4], y: t[5] }, n, !0);
    ...
    loadImage: function (t, e, n, r) {
      ...
      (i.onload = a),
        ...
        0 !== t.indexOf("data") && r && (i.crossOrigin = r),
        "data:image/svg" === t.substring(0, 14) &&
          ((i.onload = null), fabric.util.loadImageInDom(i, a)),
        (i.src = t);
    },
    ...
    enlivenObjects: function (t, e, n, r) {
      ...
      return c
        ? void t.forEach(function (t, e) {
            ...
            var o = fabric.util.getKlass(t.type, n);
            o.fromObject(t, function (n, o) {
              o || (a[e] = n), r && r(t, n, o), i();
            });
          })
        : void (e && e(a));
    ...
    populateWithProperties: function (t, e, n) {
      if (n && "[object Array]" === Object.prototype.toString.call(n))
        for (var r = 0, i = n.length; i > r; r++)
          n[r] in t && (e[n[r]] = t[n[r]]);
    },
    drawDashedLine: function (t, r, i, a, o, c) {
      var s = a - r,
        u = o - i,
        f = e(s * s + u * u),
        l = n(u, s),
        ...
        b = !0;
      for (
        t.save(), t.translate(r, i), t.moveTo(0, 0), t.rotate(l), r = 0;
        f > r;

      )
        (r += c[d++ % h]),
          r > f && (r = f),
          t[b ? "lineTo" : "moveTo"](r, 0),
          (b = !b);
      t.restore();
    },
    ...
    calcDimensionsMatrix: function (t) {
      var e = "undefined" == typeof t.scaleX ? 1 : t.scaleX,
        n = "undefined" == typeof t.scaleY ? 1 : t.scaleY,
        r = [t.flipX ? -e : e, 0, 0, t.flipY ? -n : n, 0, 0],
        i = fabric.util.multiplyTransformMatrices,
        a = fabric.util.degreesToRadians;
      return (
        t.skewX && (r = i(r, [1, 0, Math.tan(a(t.skewX)), 1], !0)),
        t.skewY && (r = i(r, [1, Math.tan(a(t.skewY)), 0, 1], !0)),
        r
      );
    },
    composeMatrix: function (t) {
      ...
      return (
        t.angle && (e = n(e, fabric.util.calcRotateMatrix(t))),
        (t.scaleX || t.scaleY || t.skewX || t.skewY || t.flipX || t.flipY) &&
          (e = n(e, fabric.util.calcDimensionsMatrix(t))),
        e
      );
    },
    customTransformMatrix: function (t, e, n) {
      return fabric.util.composeMatrix({ scaleX: t, scaleY: e, skewX: n });
    },
    ...
    isTransparent: function (t, e, n, r) {
      ...
      var i,
        a,
        o = !0,
        c = t.getImageData(e, n, 2 * r || 1, 2 * r || 1),
        s = c.data.length;
      for (i = 3; s > i && ((a = c.data[i]), (o = 0 >= a), o !== !1); i += 4);
      return (c = null), o;
    },
...
!(function () {
  function e(e, t, r, n, i, a, c, o, s, f, u) {
    var l = fabric.util.cos(e),
      ...
      y = m + s * (r * i * b + n * a * d),
      w = p + s * (n * i * b - r * a * d);
    return ["C", v, g, y, w, m, p];
  }
  function t(t, n, i, a, c, o, s) {
    var f = Math.PI,
      u = (s * f) / 180,
      l = fabric.util.sin(u),
      h = fabric.util.cos(u),
    ...
    var m = -h * t * 0.5 - l * n * 0.5,
      ...
      _ = 0;
    if (0 > x) {
      var M = Math.sqrt(1 - x / (v * g));
      (i *= M), (a *= M);
    } else _ = (c === o ? -1 : 1) * Math.sqrt(x / (v * y + g * w));
    var C = (_ * i * p) / a,
      P = (-_ * a * m) / i,
      T = h * C - l * P + 0.5 * t,
      O = l * C + h * P + 0.5 * n,
      k = r(1, 0, (m - C) / i, (p - P) / a),
      j = r((m - C) / i, (p - P) / a, (-m - C) / i, (-p - P) / a);
    0 === o && j > 0 ? (j -= 2 * f) : 1 === o && 0 > j && (j += 2 * f);
    for (
      var S = Math.ceil(Math.abs((j / f) * 2)),
        L = [],
        D = j / S,
        F = ((8 / 3) * Math.sin(D / 4) * Math.sin(D / 4)) / Math.sin(D / 2),
        E = k + D,
        I = 0;
      S > I;
      I++
    )
      (L[I] = e(k, E, h, l, i, a, T, O, F, d, b)),
        (d = L[I][5]),
        (b = L[I][6]),
        (k = E),
        (E += D);
      ...
      if (
        ...
        (m = u * u - 4 * l * f),
          0 > m ||
            ...
            (b = (-u - p) / (2 * f)),
            b > 0 && 1 > b && x.push(b));
    for (var P, T, O, k = x.length, j = k; k--; )
      (h = x[k]),
        (O = 1 - h),
        (P =
          O * O * O * e +
        ...
        (T =
          ...
          h * h * h * o),
        (M[1][k] = T);
    (M[0][j] = e), (M[1][j] = t), (M[0][j + 1] = c), (M[1][j + 1] = o);
    var S = [
      { x: g.apply(null, M[0]), y: g.apply(null, M[1]) },
      { x: y.apply(null, M[0]), y: y.apply(null, M[1]) },
    ];
    return fabric.cachesBoundsOfCurve && (fabric.boundsOfCurveCache[s] = S), S;
  }
  function i(e, r, n) {
    for (
      var i = n[1],
    ...
    for (r = 0; u > r; ++r) {
      switch (((n = !1), (t = e[r].slice(0)), t[0])) {
        ...
        case "v":
          t[1] += f;
        case "V":
          (t[0] = "L"), (f = t[1]), (t[1] = s), (t[2] = f);
          break;
        case "m":
          (t[0] = "M"), (t[1] += s), (t[2] += f);
        case "M":
          (s = t[1]), (f = t[2]), (l = t[1]), (h = t[2]);
          break;
        case "c":
          (t[0] = "C"),
            (t[1] += s),
            ...
            (t[6] += f);
        case "C":
          (c = t[3]), (o = t[4]), (s = t[5]), (f = t[6]);
          break;
        case "s":
          (t[0] = "S"), (t[1] += s), (t[2] += f), (t[3] += s), (t[4] += f);
        case "S":
          ...
          break;
        case "q":
          (t[0] = "Q"), (t[1] += s), (t[2] += f), (t[3] += s), (t[4] += f);
        case "Q":
          (c = t[1]), (o = t[2]), (s = t[3]), (f = t[4]);
          break;
        case "t":
          (t[0] = "T"), (t[1] += s), (t[2] += f);
        case "T":
        ...
        case "a":
          (t[0] = "A"), (t[6] += s), (t[7] += f);
        case "A":
          (n = !0), (d = d.concat(i(s, f, t))), (s = t[6]), (f = t[7]);
          break;
        case "z":
        case "Z":
          (s = l), (f = h);
  ...
  function m(e, t, r, n, i, a) {
    return function (c) {
      var o = h(c),
        s = d(c),
        f = b(c);
      return { x: i * o + r * s + e * f, y: a * o + n * s + t * f };
    };
  }
  function p(e, t, r) {
    var n,
      ...
      a = { x: t, y: r },
      o = 0;
    for (i = 0.01; 1 >= i; i += 0.01)
      (n = e(i)), (o += c(a.x, a.y, n.x, n.y)), (a = n);
    return o;
  }
  function v(e) {
    for (
      ...
      switch (((t = e[d]), (n = { x: o, y: s, command: t[0] }), t[0])) {
        case "M":
          (n.length = 0), (f = o = t[1]), (u = s = t[2]);
          break;
        case "L":
          (n.length = c(o, s, t[1], t[2])), (o = t[1]), (s = t[2]);
          break;
        case "C":
          (r = l(o, s, t[1], t[2], t[3], t[4], t[5], t[6])),
            (n.length = p(r, o, s)),
            (o = t[5]),
            (s = t[6]);
          break;
        case "Q":
          (r = m(o, s, t[1], t[2], t[3], t[4])),
            (n.length = p(r, o, s)),
            (o = t[3]),
            (s = t[4]);
          break;
    ...
    return h.push({ length: i, x: o, y: s }), h;
  }
  function g(e, t, r) {
    r || (r = v(e));
    for (var n = r[r.length - 1] * t, i = 0; n - r[i] > 0 && i < r.length; )
      (n -= r[i]), i++;
    var a = r[i],
      c = n / a.length,
      o = a.length,
    ...
    switch (o) {
      case "Z":
      case "z":
        return new fabric.Point(a.x, a.y).lerp(
          new fabric.Point(a.destX, a.destY),
          c
        );
      case "L":
        return new fabric.Point(a.x, a.y).lerp(new fabric.Point(s[1], s[2]), c);
      case "C":
        return l(a.x, a.y, s[1], s[2], s[3], s[4], s[5], s[6])(c);
      case "Q":
        return m(a.x, a.y, s[1], s[2], s[3], s[4])(c);
    }
  }
  function y(e) {
    var t,
    ...
    if (!e || !e.match) return c;
    a = e.match(/[mzlhvcsqta][^mzlhvcsqta]*/gi);
    for (var f, u = 0, l = a.length; l > u; u++) {
      for (t = a[u], i = t.slice(1).trim(), o.length = 0; (n = s.exec(i)); )
        o.push(n[0]);
      f = [t.charAt(0)];
      for (var h = 0, d = o.length; d > h; h++)
        (r = parseFloat(o[h])), isNaN(r) || f.push(r);
      var b = f[0],
        m = M[b.toLowerCase()],
        p = C[b] || b;
      if (f.length - 1 > m)
        for (var v = 1, g = f.length; g > v; v += m)
          c.push([b].concat(f.slice(v, v + m))), (b = p);
      else c.push(f);
    }
    return c;
  }
  function w(e, r, i, a, c, o, s, f, u) {
    for (
      var l,
        h = 0,
        d = 0,
        b = [],
        m = t(f - e, u - r, i, a, o, s, c),
        p = 0,
        v = m.length;
      v > p;
      p++
    )
      (l = n(h, d, m[p][1], m[p][2], m[p][3], m[p][4], m[p][5], m[p][6])),
        b.push({ x: l[0].x + e, y: l[0].y + r }),
        b.push({ x: l[1].x + e, y: l[1].y + r }),
        (h = m[p][5]),
        (d = m[p][6]);
    return b;
  }
  function x(e, t, r, n) {
    n = n.slice(0).unshift("X");
    var a = i(t, r, n);
  ...
  var _ = Array.prototype.join,
    M = { m: 2, l: 2, h: 1, v: 1, c: 6, s: 4, q: 4, t: 2, a: 7 },
    C = { m: "l", M: "L" };
  (fabric.util.parsePath = y),
    (fabric.util.makePathSimpler = a),
    (fabric.util.getPathSegmentsInfo = v),
    (fabric.util.fromArcToBeizers = i),
    (fabric.util.getBoundsOfCurve = n),
    (fabric.util.getPointOnPath = g),
    (fabric.util.getBoundsOfArc = w),
    (fabric.util.drawArc = x);
})();
!(function () {
  function e(e, t) {
    for (var r = a.call(arguments, 2), n = [], i = 0, c = e.length; c > i; i++)
  ...
  function i(e, t, r) {
    if (e && 0 !== e.length) {
      var n = e.length - 1,
        i = t ? e[n][t] : e[n];
      if (t) for (; n--; ) r(e[n][t], i) && (i = e[n][t]);
      else for (; n--; ) r(e[n], i) && (i = e[n]);
      return i;
    }
  }
  var a = Array.prototype.slice;
  fabric.util.array = { fill: n, invoke: e, min: r, max: t };
})();
!(function () {
  function e(t, r, n) {
    if (n)
      if (!fabric.isLikelyNode && r instanceof Element) t = r;
        ...
        t = [];
        for (var i = 0, a = r.length; a > i; i++) t[i] = e({}, r[i], n);
...
!(function () {
  ...
  function n(t) {
    var e,
      r = 0,
      n = [];
    for (r = 0, e; r < t.length; r++) (e = i(t, r)) !== !1 && n.push(e);
    return n;
  }
  function i(t, e) {
...
!(function () {
  ...
  function a(t) {
    ...
    if (!n) return o;
    for (var s in c) o[c[s]] += parseInt(d(t, s), 10) || 0;
    return (
      (e = n.documentElement),
  ...
  try {
    s = f(fabric.document.childNodes) instanceof Array;
  } catch (l) {}
  s ||
    (f = function (t) {
  ...
  (d =
    ...
    (function () {
      function t(t, e) {
        var r = fabric.document.getElementsByTagName("head")[0],
  ...
  function r(r) {
    n(function (i) {
      ...
      var a,
        ...
        l = r.onComplete || t,
        d = r.easing || e,
        h = "startValue" in r ? r.startValue : 0,
        p = "endValue" in r ? r.endValue : 100,
        b = r.byValue || p - h;
      r.onStart && r.onStart(),
        (function m(t) {
          a = t || +new Date();
...
!(function (t) {
  ...
  return r.Intersection
    ? void r.warn("fabric.Intersection is already defined")
    : ((r.Intersection = e),
      (r.Intersection.prototype = {
        constructor: e,
      ...
      (r.Intersection.intersectLineLine = function (t, i, n, a) {
        var o,
          s = (a.x - n.x) * (t.y - n.y) - (a.y - n.y) * (t.x - n.x),
          c = (i.x - t.x) * (t.y - n.y) - (i.y - t.y) * (t.x - n.x),
          l = (a.y - n.y) * (i.x - t.x) - (a.x - n.x) * (i.y - t.y);
        if (0 !== l) {
          var u = s / l,
            f = c / l;
          u >= 0 && 1 >= u && f >= 0 && 1 >= f
            ? ((o = new e("Intersection")),
              o.appendPoint(
                new r.Point(t.x + u * (i.x - t.x), t.y + u * (i.y - t.y))
              ))
            : (o = new e());
        } else o = new e(0 === s || 0 === c ? "Coincident" : "Parallel");
        return o;
      }),
      (r.Intersection.intersectLinePolygon = function (t, r, i) {
        var n,
          a,
          o,
          s,
        ...
        for (s = 0; l > s; s++)
          (n = i[s]),
            (a = i[(s + 1) % l]),
            (o = e.intersectLineLine(t, r, n, a)),
            c.appendPoints(o.points);
        return c.points.length > 0 && (c.status = "Intersection"), c;
      }),
      (r.Intersection.intersectPolygonPolygon = function (t, r) {
        var i,
          n = new e(),
          a = t.length;
        for (i = 0; a > i; i++) {
          var o = t[i],
            s = t[(i + 1) % a],
            c = e.intersectLinePolygon(o, s, r);
          n.appendPoints(c.points);
        }
        return n.points.length > 0 && (n.status = "Intersection"), n;
      }),
      void (r.Intersection.intersectPolygonRectangle = function (t, i, n) {
        var a = i.min(n),
          o = i.max(n),
          s = new r.Point(o.x, a.y),
          c = new r.Point(a.x, o.y),
          l = e.intersectLinePolygon(a, s, t),
          u = e.intersectLinePolygon(s, o, t),
  ...
  (fabric.StaticCanvas = fabric.util.createClass(fabric.CommonMethods, {
    ...
    setViewportTransform: function (t) {
      ...
      for (
        ...
        (e = this._objects[r]), e.group || e.setCoords(a, o);
      return (
        n && "activeSelection" === n.type && n.setCoords(a, o),
    ...
    _toObjectMethod: function (e, r) {
      ...
      return (
        i && (n.clipPath = this._toObject(this.clipPath, e, r)),
    ...
    __serializeBgOverlay: function (t, e) {
      ...
      return (
        this.backgroundColor &&
          (r.background = this.backgroundColor.toObject
            ? this.backgroundColor.toObject(e)
            : this.backgroundColor),
        this.overlayColor &&
          (r.overlay = this.overlayColor.toObject
    ...
    createSVGFontFacesMarkup: function () {
      var t,
        ...
        h = [];
      for (
        this._objects.forEach(function b(t) {
          h.push(t), t._objects && t._objects.forEach(b);
        }),
          s = 0,
          c = h.length;
        c > s;
...
!(function () {
  ...
  fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, {
    ...
    _resetCurrentTransform: function () {
      ...
      t.target.set({
        ...
        this._shouldCenterTransform(t.target)
          ? ("center" !== t.originX &&
              (t.mouseXSign = "right" === t.originX ? -1 : 1),
            "center" !== t.originY &&
              (t.mouseYSign = "bottom" === t.originY ? -1 : 1),
            (t.originX = "center"),
            (t.originY = "center"))
    ...
    containsPoint: function (t, e, i) {
      var r,
        n = !0,
        a = i || this.getPointer(t, n);
      return (
        (r =
          e.group &&
          e.group === this._activeObject &&
          "activeSelection" === e.group.type
            ? this._normalizePointer(e.group, a)
            : { x: a.x, y: a.y }),
    ...
    isTargetTransparent: function (t, e, i) {
      ...
      var o = fabric.util.isTransparent(s, e, i, this.targetFindTolerance);
      return o;
    },
    ...
    _setupCurrentTransform: function (t, i, r) {
      if (i) {
        var n = this.getPointer(t),
          ...
          o = this._getActionFromCorner(r, a, t, i),
          s = this._getOriginFromCorner(i, a);
    ...
    _translateObject: function (t, e) {
      var i = this._currentTransform,
        ...
        s = !r.get("lockMovementY") && r.top !== a;
      return o && r.set("left", n), s && r.set("top", a), o || s;
    },
    _changeSkewTransformOrigin: function (t, e, i) {
      ...
      (t = t > 0 ? 1 : -1),
        "y" === i &&
          ((a = e.target.skewY), (o = "top"), (s = "bottom"), (r = "originY")),
        (n[-1] = o),
        (n[1] = s),
        e.target.flipX && (l *= -1),
        e.target.flipY && (l *= -1),
        0 === a
          ? ((e.skewSign = -c * t * l), (e[r] = n[-t]))
          : ((a = a > 0 ? 1 : -1), (e.skewSign = a), (e[r] = n[a * c * l]));
    },
    _skewObject: function (t, e, i) {
      var r = this._currentTransform,
        ...
        s = n.get("lockSkewingY");
      if ((o && "x" === i) || (s && "y" === i)) return !1;
      var c,
        l,
        u = n.getCenterPoint(),
        h = n.toLocalPoint(new fabric.Point(t, e), "center", "center")[i],
        f = n.toLocalPoint(
      ...
      return (
        this._changeSkewTransformOrigin(h - f, r, i),
        (c = n.toLocalPoint(new fabric.Point(t, e), r.originX, r.originY)[i]),
        (l = n.translateToOriginPoint(u, r.originX, r.originY)),
        (a = this._setObjectSkew(c, r, i, d)),
        (r.lastX = t),
        (r.lastY = e),
        n.setPositionByOrigin(l, r.originX, r.originY),
        a
      );
    },
    _setObjectSkew: function (t, e, i, r) {
      ...
      return (
        "x" === i
          ? ((s = "y"), (c = "Y"), (l = "X"), (h = 0), (f = d.skewY))
          : ((s = "x"), (c = "X"), (l = "Y"), (h = d.skewX), (f = 0)),
        (o = d._getTransformedDimensions(h, f)),
        (u = 2 * Math.abs(t) - o[i]),
        2 >= u
          ? (n = 0)
          : ((n = p * Math.atan(u / d["scale" + l] / (o[s] / d["scale" + c]))),
            (n = fabric.util.radiansToDegrees(n))),
        (g = d["skew" + l] !== n),
        d.set("skew" + l, n),
        0 !== d["skew" + c] &&
          ((a = d._getTransformedDimensions()),
          (n = (r[s] / a[s]) * d["scale" + c]),
          d.set("scale" + c, n)),
        g
      );
    ...
    _scaleObject: function (t, e, i) {
      var r = this._currentTransform,
        ...
        s = n.lockScalingFlip;
      if (a && o) return !1;
      var c = n.translateToOriginPoint(
          n.getCenterPoint(),
          r.originX,
          r.originY
        ),
      ...
      return (
        ...
        (h = this._setObjectScale(l, r, a, o, i, s, u)),
        n.setPositionByOrigin(c, r.originX, r.originY),
        h
      );
    },
    _setObjectScale: function (t, e, i, r, n, a, o) {
      var s = e.target,
        c = !1,
        l = !1,
        u = !1,
      ...
      if (
        ((e.newScaleX = h),
        (e.newScaleY = f),
        fabric.Textbox && "x" === n && s instanceof fabric.Textbox)
      ) {
        var p = s.width * (t.x / o.x);
        return p >= s.getMinWidth()
          ? ((u = p !== s.width), s.set("width", p), u)
          : !1;
      }
      return (
        a && 0 >= h && h < s.scaleX && ((c = !0), (t.x = 0)),
        a && 0 >= f && f < s.scaleY && ((l = !0), (t.y = 0)),
        "equally" !== n || i || r
          ? n
            ? "x" !== n || s.get("lockUniScaling")
              ? "y" !== n ||
                s.get("lockUniScaling") ||
                l ||
                r ||
                (s.set("scaleY", f) && (u = g))
              : c || i || (s.set("scaleX", h) && (u = d))
            : (c || i || (s.set("scaleX", h) && (u = u || d)),
              l || r || (s.set("scaleY", f) && (u = u || g)))
          : (u = this._scaleObjectEqually(t, s, e, o)),
        c || l || this._flipObject(e, n),
        u
      );
    },
    _scaleObjectEqually: function (t, e, i, r) {
      var n,
        ...
        u = t.y < 0 ? -1 : 1;
      return (
        (a = l * Math.abs((i.original.scaleX * s) / c)),
        (o = u * Math.abs((i.original.scaleY * s) / c)),
        (n = a !== e.scaleX || o !== e.scaleY),
        e.set("scaleX", a),
        e.set("scaleY", o),
        n
      );
    ...
    _setLocalMouse: function (t, e) {
      ...
      "right" === e.originX
        ...
        n(t.x) > a ? (t.x < 0 ? (t.x += a) : (t.x -= a)) : (t.x = 0),
        n(t.y) > a ? (t.y < 0 ? (t.y += a) : (t.y -= a)) : (t.y = 0);
    },
    _rotateObject: function (t, e) {
      var n,
        a = this._currentTransform,
        o = a.target,
        n = o.translateToOriginPoint(o.getCenterPoint(), a.originX, a.originY);
      if (o.lockRotation) return !1;
      var s = r(a.ey - n.y, a.ex - n.x),
        c = r(e - n.y, t - n.x),
        l = i(c - s + a.theta),
        u = !0;
      if (o.snapAngle > 0) {
      ...
      return (
        ...
        o.angle === l
          ? (u = !1)
          : ((o.angle = l), o.setPositionByOrigin(n, a.originX, a.originY)),
        u
      );
    },
    ...
    _drawSelection: function (t) {
      ...
      if (
        (this.selectionColor &&
          ...
          t.fillRect(e.ex - (i > 0 ? 0 : -i), e.ey - (r > 0 ? 0 : -r), s, c)),
    ...
    findTarget: function (t, e) {
      if (!this.skipTargetFind) {
        var i,
          r,
          n = !0,
          a = this.getPointer(t, n),
          o = this._activeObject,
          s = this.getActiveObjects();
        if (
          ((this.targets = []),
          s.length > 1 && !e && o === this._searchPossibleTargets([o], a))
        )
          return o;
        if (1 === s.length && o._findTargetCorner(a)) return o;
        if (1 === s.length && o === this._searchPossibleTargets([o], a)) {
    ...
    _searchPossibleTargets: function (t, e) {
      for (var i, r, n = t.length; n--; ) {
        var a = t[n],
          o =
            a.group && "activeSelection" !== a.group.type
              ? this._normalizePointer(a.group, e)
              : e;
    ...
    _fireSelectionEvents: function (t, e) {
      ...
      t.forEach(function (t) {
        -1 === r.indexOf(t) && ((i = !0), t.fire("deselected", o), a.push(t));
      }),
        ...
        t.length > 0 && r.length > 0
          ...
          : t.length > 0 &&
            ((o.deselected = a), this.fire("selection:cleared", o));
    },
  ...
  for (var s in fabric.StaticCanvas)
    "prototype" !== s && (fabric.Canvas[s] = fabric.StaticCanvas[s]);
})();
!(function () {
  function t(t, e) {
  ...
  fabric.util.object.extend(fabric.Canvas.prototype, {
    ...
    addOrRemove: function (t, e) {
      ...
      t(fabric.window, "resize", this._onResize),
        ...
        t(i, r + "move", this._onMouseMove, a),
    ...
    removeListeners: function () {
      ...
      r(fabric.document, t + "up", this._onMouseUp),
        r(fabric.document, "touchend", this._onTouchEnd, a),
        r(fabric.document, t + "move", this._onMouseMove, a),
        r(fabric.document, "touchmove", this._onMouseMove, a);
    },
    ...
    _onTouchStart: function (t) {
      ...
      i(fabric.document, "touchend", this._onTouchEnd, a),
        ...
        r(e, n + "down", this._onMouseDown);
    },
    _onMouseDown: function (t) {
      this.__onMouseDown(t), this._resetTransformEventData();
      var e = this.upperCanvasEl,
        n = this._getEventPrefix();
      r(e, n + "move", this._onMouseMove, a),
        i(fabric.document, n + "up", this._onMouseUp),
        i(fabric.document, n + "move", this._onMouseMove, a);
    },
      ...
      if (!(t.touches.length > 0)) {
        ...
        this._willAddMouseDown && clearTimeout(this._willAddMouseDown),
          (this._willAddMouseDown = setTimeout(function () {
            i(n.upperCanvasEl, e + "down", n._onMouseDown),
    ...
    _onMouseUp: function (t) {
      ...
      var e = this.upperCanvasEl,
        n = this._getEventPrefix();
      this._isMainEvent(t) &&
        (r(fabric.document, n + "up", this._onMouseUp),
        r(fabric.document, n + "move", this._onMouseMove, a),
        i(e, n + "move", this._onMouseMove, a));
    },
    ...
    __onMouseUp: function (e) {
      ...
      return (
        ...
        t(e, n)
          ? void (this.fireRightClick && this._handleEvent(e, "up", n, l))
          : t(e, s)
          ? (this.fireMiddleClick && this._handleEvent(e, "up", s, l),
          ...
          : void (
              this._isMainEvent(e) &&
              (r &&
                (this._finalizeCurrentTransform(e), (c = r.actionPerformed)),
              l ||
                (this._maybeGroupObjects(e), c || (c = this._shouldRender(i))),
              i && (i.isMoving = !1),
              this._setCursorFromEvent(e, i),
              this._handleEvent(e, "up", o, l),
              (this._groupSelector = null),
              (this._currentTransform = null),
              i && (i.__corner = 0),
    ...
    fireSyntheticInOutEvents: function (t, e, i) {
      ...
      c &&
        ...
        (o = t && c),
        (s = a && c),
        s && (h && this.fire(h, n), a.fire(i.evtOut, n)),
    ...
    getCornerCursor: function (t, i, r) {
      return this.actionIsDisabled(t, i, r)
        ? this.notAllowedCursor
        : t in e
        ? this._getRotatedCornerCursor(t, i, r)
    ...
    _collectObjects: function (i) {
      for (
        var r,
          ...
          l = new fabric.Point(t(s, a), t(o, c)),
          h = new fabric.Point(e(s, a), e(o, c)),
        ...
        !(
          ...
          r.selectable &&
          r.visible &&
          ((u && r.intersectsWithRect(l, h)) ||
            r.isContainedWithinRect(l, h) ||
            (u && r.containsPoint(l)) ||
            (u && r.containsPoint(h))) &&
          (n.push(r), f)
        ));
  ...
  e.Object ||
    ((e.Object = e.util.createClass(e.CommonMethods, {
      ...
      _updateCacheCanvas: function () {
        ...
        return p
          ? (m
              ? ((o.width = Math.ceil(h + v)), (o.height = Math.ceil(l + b)))
      ...
      _renderControls: function (t, i) {
        ...
        (i = i || {}),
          ...
          i.forActiveSelection
            ? (t.rotate(o(r.angle)), n && this.drawBordersInGroup(t, r, i))
            : (t.rotate(o(this.angle)), n && this.drawBorders(t, i)),
...
!(function () {
  ...
  fabric.util.object.extend(fabric.Object.prototype, {
    ...
    isOnScreen: function (t) {
      ...
      for (
        ...
        if (((e = n[s]), e.x <= r.x && e.x >= i.x && e.y <= r.y && e.y >= i.y))
          return !0;
      return this.intersectsWithRect(i, r, !0, t)
        ? !0
    ...
    calcCoords: function (t) {
      ...
      if (!t) {
        ...
        var O = new fabric.Point((f.x + g.x) / 2, (f.y + g.y) / 2),
          ...
          E = new fabric.Point((v.x + g.x) / 2, (v.y + g.y) / 2),
          j = new fabric.Point(
            T.x + _ * this.rotatingPointOffset,
            T.y - m * this.rotatingPointOffset
          );
      }
      var P = { tl: f, tr: d, br: v, bl: g };
      return (
        t || ((P.ml = O), (P.mt = T), (P.mr = S), (P.mb = E), (P.mtr = j)), P
      );
    },
    ...
    calcTransformMatrix: function (t) {
      ...
      return (
        this.group && (n = i(this.group.calcTransformMatrix(), n)),
        (r.key = e),
        (r.value = n),
        n
      );
...
!(function () {
  ...
  fabric.util.object.extend(fabric.Object.prototype, {
    ...
    getSvgTransform: function (t, e) {
      ...
      return r + (e || "") + this.getSvgTransformMatrix() + '" ';
    },
  ...
  fabric.util.object.extend(fabric.Object.prototype, {
    ...
    drawBordersInGroup: function (t, e, i) {
      ...
      var r = { x: this.width, y: this.height },
        ...
        c =
          s.x + o * (this.strokeUniform ? this.canvas.getZoom() : e.scaleX) + a,
        h =
          s.y + o * (this.strokeUniform ? this.canvas.getZoom() : e.scaleY) + a;
      return (
        t.save(),
...
!(function (t) {
  ...
  var e = t.fabric || (t.fabric = {}),
    ...
    o = e.util.drawArc,
    a = e.util.toFixed,
    c = { m: 2, l: 2, h: 1, v: 1, c: 6, s: 4, q: 4, t: 2, a: 7 },
    h = { m: "l", M: "L" };
  return e.Path
    ...
    : ((e.Path = e.util.createClass(e.Object, {
        ...
        _parsePath: function () {
          for (
            ...
            for (
              t = this.path[u], n = t.slice(1).trim(), a.length = 0;
              (r = l.exec(n));
            ...
            for (var d = 0, g = a.length; g > d; d++)
              (i = parseFloat(a[d])), isNaN(i) || s.push(i);
            var p = s[0],
              v = c[p.toLowerCase()],
              b = h[p] || p;
            if (s.length - 1 > v)
              for (var m = 1, y = s.length; y > m; m += v)
                o.push([p].concat(s.slice(m, m + v))), (p = b);
            else o.push(s);
          }
          return o;
        },
        _calcDimensions: function () {
          ...
          var m = i(a) || 0,
            ...
            w = _ - m,
            x = C - y;
          return { left: m, top: y, width: w, height: x };
        },
      })),
          ...
          _renderFill: function (t) {
            ...
            if (e) {
              var i = this._filterScalingX,
                ...
                m = o(n, l / i - c),
                _ = o(s, u / i - h);
              e && t.drawImage(e, f, d, g, p, v, b, m, _);
            }
          },
    ...
    : ((e.Text = e.util.createClass(e.Object, {
        ...
        _renderChars: function (t, e, i, r, n, s) {
          ...
          for (var p = 0, v = i.length - 1; v >= p; p++)
            (h = p === v || this.charSpacing),
              ...
              0 === d
                ? ((r += c.kernedWidth - c.width), (d += c.width))
                : (d += c.kernedWidth),
        ...
        getLineWidth: function (t) {
          ...
          var e,
            ...
            r = this._textLines[t];
          return (
            "" === r ? (e = 0) : ((i = this.measureLine(t)), (e = i.width)),
            ...
            for (
              ...
              if (
                ...
                (c = this._textLines[C]),
                  ...
                  (b = this.getValueOfPropertyAt(C, 0, "fill")),
      ...
      (e.Text.fromElement = function (t, r, n) {
        ...
        var s = e.parseAttributes(t, e.Text.ATTRIBUTE_NAMES),
          o = s.textAnchor || "left";
        if (
          ((n = e.util.object.extend(n ? i(n) : {}, s)),
          (n.top = n.top || 0),
          (n.left = n.left || 0),
          s.textDecoration)
        ) {
        ...
        for (var c in n[h]) {
          ...
          s++,
            l
              ...
              : (o = !1),
            0 !== Object.keys(r).length ? e++ : delete n[h][c];
        }
        0 === e && delete n[h];
      }
...
!(function () {
  ...
  (fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, {
    ...
    _getCursorBoundariesOffsets: function (t) {
      ...
      for (var h = 0; i > h; h++) s += this.getHeightOfLine(h);
    ...
    renderSelection: function (t, e) {
      for (
        ...
        var f = this._getLineLeftOffset(u) || 0,
          ...
          p = 0,
          v = 0;
        if ((u === a && (p = this.__charBounds[a][c].left), u >= a && h > u))
          v =
        ...
        (g = d),
          ...
          this.inCompositionMode
            ? ((e.fillStyle = this.compositionColor || "black"),
              e.fillRect(t.left + f + p, t.top + t.topOffset + d, v - p, 1))
            : ((e.fillStyle = this.selectionColor),
              e.fillRect(t.left + f + p, t.top + t.topOffset, v - p, d)),
          (t.topOffset += g);
      }
    },
  ...
  fabric.util.object.extend(fabric.IText.prototype, {
    ...
    removeStyleFromTo: function (t, e) {
      ...
      if (o !== h) {
        ...
        for (i = o + 1; h >= i; i++) delete this.styles[i];
        ...
        var l,
          u,
          f = c - a;
        for (i = a; c > i; i++) delete r[i];
        for (u in this.styles[o])
          (l = parseInt(u, 10)), l >= c && ((r[l - f] = r[u]), delete r[u]);
      }
    },
    ...
    insertNewlineStyleObject: function (e, i, r, n) {
      ...
      for (var c in this.styles[e]) {
        ...
        l >= i &&
          ((a = !0),
          (o[l - i] = this.styles[e][c]),
          (h && 0 === i) || delete this.styles[e][c]);
      }
      var u = !1;
      for (a && !h && ((this.styles[e + r] = o), (u = !0)), u && r--; r > 0; )
        n && n[r - 1]
...
fabric.util.object.extend(fabric.IText.prototype, {
    ...
    if (((this.fromPaste = !1), t && t.stopPropagation(), this.isEditing)) {
      ...
      (r = a.slice(g.selectionEnd - l, g.selectionEnd)),
        i &&
          i.length &&
          (r.length &&
            ((n = this.getSelectionStyles(u, u + 1, !0)),
            (n = r.map(function () {
              return n[0];
            }))),
          d
  ...
  getDownCursorOffset: function (t, e) {
    ...
    return h.length + a + 1 + this.missingNewlineOffset(n);
  },
  ...
  (e.Textbox = e.util.createClass(e.IText, e.Observable, {
    ...
    _wrapLine: function (t, i, n, r) {
      var s = 0,
        ...
        p = 0,
        v = !0,
        _ = o ? 0 : this._getWidthOfCharSpacing(),
        r = r || 0;
      0 === c.length && c.push([]), (n -= r);
      for (var b = 0; b < c.length; b++)
        (l = o ? c[b] : e.util.string.graphemeSplit(c[b])),
          (d = this._measureWord(l, i, u)),
          (u += l.length),
          (s += g + d - _),
          s >= n && !v ? (a.push(h), (h = []), (s = d), (v = !0)) : (s += _),
          v || o || h.push(f),
          (h = h.concat(l)),
      ...
      return (
        b && a.push(h),
        p + r > this.dynamicMinWidth && (this.dynamicMinWidth = p - _ + r),
        a
      );
    },
    isEndOfWrapping: function (t) {
